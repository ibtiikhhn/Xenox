package com.globalsolutions.Tattle.Utils;
...
public class WebRtcSessionManager extends QBRTCClientSessionCallbacksImpl {
    private static final String TAG = com.globalsolutions.Tattle.Utils.WebRtcSessionManager.class.getSimpleName();

    private static com.globalsolutions.Tattle.Utils.WebRtcSessionManager instance;
    ...
    public static com.globalsolutions.Tattle.Utils.WebRtcSessionManager getInstance(Context context) {
        if (instance == null) {
            instance = new com.globalsolutions.Tattle.Utils.WebRtcSessionManager(context);
        }
